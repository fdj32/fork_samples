/**
 * https://www.cs.kent.edu/~ruttan/sysprog/lectures/multi-thread/thread-pool-server-changes/main.c
 */
...
pthread_mutex_t request_mutex = PTHREAD_RECURSIVE_MUTEX_INITIALIZER;//_NP;
