...
static struct PrintOptions {
    ...
    constexpr static bool separate_year_month  = 0;
...
static CompilerFeature cxx26_core[] = {
//< Populate
COMPILER_FEATURE_ENTRY(__cpp_core_TODO)
};
static CompilerFeature cxx26_lib[] = {
//< Populate
...
inline void print_compiler_feature(const CompilerFeature& x) {
    ...
    if (print.separate_year_month) value.insert(4, 1, '-'); //~ 201603 -> 2016-03
